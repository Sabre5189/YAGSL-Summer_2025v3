...
public class ReefscapeReefSimulation implements SimulatedArena.Simulatable
{
  ...
  public void simulationSubTick(int subTickNum)
  {
    ...
    {
      gamePiecesLaunched.remove(toRemove);
    }
  }
  ...
  {
    for (ReefscapeReefBranchesTower tower : branchTowers)
    {
      tower.clearBranches();
    }
  }
...
final class ReefscapeReefBranch implements CoralHolder
{
  ...
  public void addContainedCoralsForDisplay(List<Pose3d> coralPosesToDisplay)
  {
    if (hasCoral)
    {
      coralPosesToDisplay.add(idealCoralPlacementPose);
    }
  }
}
...
final class ReefscapeReefTrough implements CoralHolder
{
  ...
  public void addContainedCoralsForDisplay(List<Pose3d> coralPosesToDisplay)
  {
    if (coralCount > 0)
    {
      coralPosesToDisplay.add(firstPlacementPose);
    }
    if (coralCount > 1)
    {
      coralPosesToDisplay.add(secondPlacementPose);
    }
  }
}
