...
public class GamePieceProjectile
{
   ...
   * @param robotPosition              the position of the robot (not the shooter) at the time of launching the game
   *                                   piece
   ...
   * @param initialHeight              the initial height of the game piece when launched, i.e., the height of the
   ...
   * @param chassisSpeeds          the speeds of the chassis when the game piece is launched, including translational
   *                               and rotational velocities
   * @param chassisFacing          the direction the chassis is facing at the time of the launch
   * @param groundSpeedMPS         the ground component of the projectile's initial velocity, provided as a scalar in
   ...
   * @param initialLaunchingVelocityMPS the horizontal component of the initial velocity in the X-Y plane, in meters per
   *                                    second (m/s)
   * @param initialHeight               the initial height of the game piece when launched (the height of the shooter
   *                                    from the ground)
   * @param initialVerticalSpeedMPS     the vertical component of the initial velocity, in meters per second (m/s)
   * @param gamePieceRotation           the 3D rotation of the game piece during flight (only affects visualization of
   *                                    the game piece)
   */
  public GamePieceProjectile(
      GamePieceOnFieldSimulation.GamePieceInfo info,
   ...
   *                                                         objects representing the projectile's trajectory, called if
   *                                                         the projectile will hit the target on its path
   * @param projectileTrajectoryDisplayCallBackHitTargetMiss the callback that will receive the list of {@link Pose3d}
   *                                                         objects representing the projectile's trajectory, called if
   *                                                         the projectile will be off the target
   * @return the current instance of {@link GamePieceProjectile} to allow method chaining
   */
  public GamePieceProjectile withProjectileTrajectoryDisplayCallBack(
