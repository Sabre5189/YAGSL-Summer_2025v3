 ...
 *
 * <p>The Simulation is basically an indefinite integral of the angular velocity during each simulation sub ticks.
 * Above
...
public class GyroSimulation
{
   ...
   *
   * @param AVERAGE_DRIFTING_IN_30_SECS_MOTIONLESS_DEG      the average amount of drift, in degrees, the gyro
   *                                                        experiences if it remains motionless for 30 seconds on a
   *                                                        vibrating platform. This value can often be found in the
   *                                                        user manual.
