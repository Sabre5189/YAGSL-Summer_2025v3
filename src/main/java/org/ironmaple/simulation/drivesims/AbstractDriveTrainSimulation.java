...
public abstract class AbstractDriveTrainSimulation extends Body
{
   ...
   *
   * @param config             a {@link DriveTrainSimulationConfig} instance containing the configurations of this
   *                           drivetrain
   ...
   * use a {@link SwerveDriveSimulation} together with a {@link edu.wpi.first.math.estimator.SwerveDrivePoseEstimator}.
   *
  ...
  public ChassisSpeeds getDriveTrainSimulatedChassisSpeedsRobotRelative()
  {
    ...
    speeds =
        speeds.toRobotRelative(getSimulatedDriveTrainPose().getRotation());
    return speeds;
  }
