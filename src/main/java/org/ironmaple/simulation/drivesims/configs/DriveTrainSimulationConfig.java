 ...
 *
 * <p>This class is used to hold all the parameters necessary for simulating a swerve drivetrain, allowing for
 * realistic
...
public class DriveTrainSimulationConfig
{
   ...
   *                                      drivetrain. You can specify one factory to apply the same configuration over
   *                                      all modules or specify four factories in the order (FL, FR, BL, BR).
   ...
   *
   * @param swerveModuleSimulationFactory the new factory (or factories) for swerve module simulations. You can specify
   *                                      one factory to apply the same configuration over all modules, or specify four
